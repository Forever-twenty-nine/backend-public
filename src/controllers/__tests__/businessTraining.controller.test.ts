...
const mockService = BusinessTrainingService as jest.MockedClass<typeof BusinessTrainingService>;
...
describe('BusinessTrainingController', () => {
  ...
  beforeEach(() => {
    const mockRepoInstance = new mockRepository({} as any) as jest.Mocked<BusinessTrainingRepository>;
    mockServiceInstance = new mockService(mockRepoInstance) as jest.Mocked<BusinessTrainingService>;
  ...
  describe('createBusinessTraining', () => {
    it('should create BusinessTraining successfully', async () => {
      ...
      mockServiceInstance.create.mockResolvedValue(createdBusinessTraining as any);

      await controller.createBusinessTraining(mockReq as Request, mockRes as Response, mockNext);

      expect(mockServiceInstance.create).toHaveBeenCalledWith(businessTrainingData);
