...
describe('CourseController', () => {
  ...
  describe('findForHome', () => {
    it('should return courses for home successfully', async () => {
      ...
      await controller.findForHome(mockReq as Request, mockRes as Response, mockNext);
  ...
  describe('findPublished', () => {
    it('should return published courses with pagination', async () => {
      ...
      await controller.findPublished(mockReq as Request, mockRes as Response, mockNext);
  ...
  describe('findOnePublic', () => {
    it('should return course if found', async () => {
      ...
      await controller.findOnePublic(mockReq as Request, mockRes as Response, mockNext);
