...
export const iWantToTrainController = new IWantToTrainController(
  iWantToTrainService,
);
export const requestACourseController = new RequestACourseController(
  requestACourseService,
);
export const businessTrainingController = new BusinessTrainingController(
  businessTrainingService,
);
